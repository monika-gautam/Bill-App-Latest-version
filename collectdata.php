         ...
         <?
          ...
          <center>
           ...
           <h4><font color="Brown"> After adding all the entries, click 'Generate Bill' button to download the PDF.</font></h4>
             ...
             <br><br>
            <input type="hidden" name="hidd" value="<?= $curr_val ?>">           <input type="button" value="Edit / See Record(s)" style="background-color: Salmon;font-weight: bold;font-size: 13pt;" onMouseOver="this.style.backgroundColor='Red'" onMouseOut="this.style.backgroundColor='Salmon'"  onClick="edit()"  />  
           &nbsp;&nbsp;&nbsp;
